...
```
java -jar javasnack-xxx.jar JmhBenchmark -h

or

java -jar javasnack-xxx.jar

Welcome to Java Snack!!
available snack names:
(...)
  JmhBenchmark
(...)
Enter snack name (exit for ENTER):JmhBenchmark
Enter JMH args (exit for ENTER):-h
