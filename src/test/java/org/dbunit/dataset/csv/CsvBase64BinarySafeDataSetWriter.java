 ...
 */
public class CsvBase64BinarySafeDataSetWriter implements IDataSetConsumer {

    /**
     * Logger for this class
     */
    private static final Logger logger = LoggerFactory
            .getLogger(CsvBase64BinarySafeDataSetWriter.class);
    ...
    public CsvBase64BinarySafeDataSetWriter(String theDirectory) {
        setTheDirectory(theDirectory);
    }

    public CsvBase64BinarySafeDataSetWriter(File theDirectory) {
    ...
    private String quote(String stringValue) throws UnsupportedEncodingException {
        logger.debug("quote(stringValue={}) - start", stringValue);

        // encode to base64 string
        byte[] rawbytes = stringValue.getBytes(CharsetTool.BINARY);
        String base64encoded = Base64.encodeBytes(rawbytes);
        // quote surround
        return new StringBuffer(QUOTE).append(base64encoded).append(QUOTE).toString();
    }
    ...
    public static void write(IDataSet dataset, File dest) throws DataSetException {
        ...
        CsvBase64BinarySafeDataSetWriter writer = new CsvBase64BinarySafeDataSetWriter(dest);
