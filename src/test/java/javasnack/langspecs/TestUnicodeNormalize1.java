...
public class TestUnicodeNormalize1 {
    ...
    class NormalizeResult {
        ...
        public int hashCode() {
            ...
            result = prime * result + ((NFD == null) ? 0 : NFD.hashCode());
            result = prime * result + ((NFKC == null) ? 0 : NFKC.hashCode());
        ...
        public boolean equals(Object obj) {
            ...
            if (getClass() != obj.getClass())
                return false;
            NormalizeResult other = (NormalizeResult) obj;
            ...
            if (NFD == null) {
                if (other.NFD != null)
                    return false;
            } else if (!NFD.equals(other.NFD))
                return false;
            if (NFKC == null) {
                if (other.NFKC != null)
                    return false;
            } else if (!NFKC.equals(other.NFKC))
                return false;
            if (NFKD == null) {
                if (other.NFKD != null)
                    return false;
        ...
        private TestUnicodeNormalize1 getOuterType() {
            return TestUnicodeNormalize1.this;
        }
    }
    ...
    @DataProvider(name = "nomalizeSamples")
    public Object[][] getNomalizeSamples() {
        return new Object[][] {
                // japanese zenkaku hiragana "a"
                { "\u3042", new NormalizeResult("\u3042", "\u3042", "\u3042", "\u3042") },
                // japanese zenkaku hiragana "ga"
                { "\u304c", new NormalizeResult("\u304c", "\u304B\u3099", "\u304c", "\u304b\u3099") },
                // japanese zenkaku hiragana "pu"
                { "\u3077", new NormalizeResult("\u3077", "\u3075\u309a", "\u3077", "\u3075\u309a") },
                // japanese zenkaku hiragana small "tsu"
                { "\u3063", new NormalizeResult("\u3063", "\u3063", "\u3063", "\u3063") },
                // japanese zenkaku hiragana "wa" + japanese dakuten
                { "\u308f\u3099", new NormalizeResult("\u308f\u3099", "\u308f\u3099", "\u308f\u3099", "\u308f\u3099") },
                // japanese zenkaku hiragana "ka" + japanese han-dakuten
                { "\u304b\u309a", new NormalizeResult("\u304b\u309a", "\u304b\u309a", "\u304b\u309a", "\u304b\u309a") },
                // japanese zenkaku katakana "a"
                { "\u30a2", new NormalizeResult("\u30a2", "\u30a2", "\u30a2", "\u30a2") },
                // japanese zenkaku katakana "vu"
                { "\u30f4", new NormalizeResult("\u30f4", "\u30a6\u3099", "\u30f4", "\u30a6\u3099") },
                // japanese zenkaku katakana "po"
                { "\u30dd", new NormalizeResult("\u30dd", "\u30db\u309a", "\u30dd", "\u30db\u309a") },
                // japanese zenkaku katakana small "ke"
                { "\u30f6", new NormalizeResult("\u30f6", "\u30f6", "\u30f6", "\u30f6") },
                // japanese zenkaku katakana "ka" + japanese han-dakuten
                { "\u30ab\u309a", new NormalizeResult("\u30ab\u309a", "\u30ab\u309a", "\u30ab\u309a", "\u30ab\u309a") },
                // japanese zenkaku katakana "to" + japanese han-dakuten
                { "\u30c8\u309a", new NormalizeResult("\u30c8\u309a", "\u30c8\u309a", "\u30c8\u309a", "\u30c8\u309a") },
                // japanese half-width kana "ha"
                { "\uff8a", new NormalizeResult("\uff8a", "\uff8a", "\u30cf", "\u30cf") },
                // japanese half-width kana "vu"
                { "\uff73\uff9e", new NormalizeResult("\uff73\uff9e", "\uff73\uff9e", "\u30f4", "\u30a6\u3099") },
                // japanese half-width kana "pa"
                { "\uff8a\uff9f", new NormalizeResult("\uff8a\uff9f", "\uff8a\uff9f", "\u30d1", "\u30cf\u309a") },
                ...
                // zenkaku marks
                {
                        ...
                        new NormalizeResult(
                                ...
                                "\\\u0075\u0066\u0066\u0030\u0031"
                                        ...
                                        + "\u0023\u0025\u0026\u0027\u0028\u0029\u002a\u002b\u002c\u002c\u002e\u002f\u003a\u003b\u003c\u003d\u003e\u003f\u0040\u005b\\\u005d\u005e\u005f\u0060\u007b\u007c\u007d\u007e") },
                // latin "A" with acute
                { "\u00c1", new NormalizeResult("\u00c1", "\u0041\u0301", "\u00c1", "\u0041\u0301") },
                // latin "A" with ring above
                { "\u00c5", new NormalizeResult("\u00c5", "\u0041\u030a", "\u00c5", "\u0041\u030a") },
                // latin "C" with cedilla
                { "\u00c7", new NormalizeResult("\u00c7", "\u0043\u0327", "\u00c7", "\u0043\u0327") },
                // latin "E" with grave
                { "\u00c8", new NormalizeResult("\u00c8", "\u0045\u0300", "\u00c8", "\u0045\u0300") },
                // latin "n" with tilde
                { "\u00f1", new NormalizeResult("\u00f1", "\u006e\u0303", "\u00f1", "\u006e\u0303") },
                // latin "o" with diaeresis
                { "\u00f6", new NormalizeResult("\u00f6", "\u006f\u0308", "\u00f6", "\u006f\u0308") },
                // latin "o" with diaeresis
                { "\u00f6", new NormalizeResult("\u00f6", "\u006f\u0308", "\u00f6", "\u006f\u0308") },
                // latin "u" with circumflex
                { "\u00fb", new NormalizeResult("\u00fb", "\u0075\u0302", "\u00fb", "\u0075\u0302") },
                // latin "AE"
                { "\u00c6", new NormalizeResult("\u00c6", "\u00c6", "\u00c6", "\u00c6") },
                // latin "ETH"
                { "\u00d0", new NormalizeResult("\u00d0", "\u00d0", "\u00d0", "\u00d0") },
                // latin "Estset"
                { "\u00df", new NormalizeResult("\u00df", "\u00df", "\u00df", "\u00df") },
                // latin "o" with stroke
                { "\u00f8", new NormalizeResult("\u00f8", "\u00f8", "\u00f8", "\u00f8") },
                // latin small thorn
                { "\u00fe", new NormalizeResult("\u00fe", "\u00fe", "\u00fe", "\u00fe") },
                // latin "B", ring above
                { "\u0042\u030a", new NormalizeResult("\u0042\u030a", "\u0042\u030a", "\u0042\u030a", "\u0042\u030a") },
                // latin "ae", grave
                { "\u00e6\u0300", new NormalizeResult("\u00e6\u0300", "\u00e6\u0300", "\u00e6\u0300", "\u00e6\u0300") },
                // acute
                { "\u00b4", new NormalizeResult("\u00b4", "\u00b4", "\u0020\u0301", "\u0020\u0301") },
                // diaeresis
                { "\u00a8", new NormalizeResult("\u00a8", "\u00a8", "\u0020\u0308", "\u0020\u0308") },
                // overline
                { "\u203e", new NormalizeResult("\u203e", "\u203e", "\u0020\u0305", "\u0020\u0305") },
                // macron
                { "\u00af", new NormalizeResult("\u00af", "\u00af", "\u0020\u0304", "\u0020\u0304") },
                // zenkaku macron
                { "\uffe3", new NormalizeResult("\uffe3", "\uffe3", "\u0020\u0304", "\u0020\u0304") },
                // cedilla
                { "\u00b8", new NormalizeResult("\u00b8", "\u00b8", "\u0020\u0327", "\u0020\u0327") },
                // japanese dakuten
                { "\u309b", new NormalizeResult("\u309b", "\u309b", "\u0020\u3099", "\u0020\u3099") },
                // japanese han-dakuten
                { "\u309c", new NormalizeResult("\u309c", "\u309c", "\u0020\u309a", "\u0020\u309a") },
                // japanese hiragana "ha", japanese dakuten
                { "\u306f\u309b",
                        new NormalizeResult("\u306f\u309b", "\u306f\u309b", "\u306f\u0020\u3099", "\u306f\u0020\u3099") },
                // japanese zenkaku katakana "ho", japanese han-dakuten
                { "\u30db\u309c",
                        new NormalizeResult("\u30db\u309c", "\u30db\u309c", "\u30db\u0020\u309a", "\u30db\u0020\u309a") },
                // japanese half-width dakuten
                { "\uff9e", new NormalizeResult("\uff9e", "\uff9e", "\u3099", "\u3099") },
                // japanese half-width han-dakuten
                { "\uff9e", new NormalizeResult("\uff9e", "\uff9e", "\u3099", "\u3099") },
                // japanese hiragana "ha", half-width dakuten
                { "\u306f\uff9e", new NormalizeResult("\u306f\uff9e", "\u306f\uff9e", "\u3070", "\u306f\u3099") },
                // japanese katakana "ho", half-width han-dakuten
                { "\u30db\uff9f", new NormalizeResult("\u30db\uff9f", "\u30db\uff9f", "\u30dd", "\u30db\u309a") },
                ...
                { "\u309e", new NormalizeResult("\u309e", "\u309d\u3099", "\u309e", "\u309d\u3099") },
                // katakana voiced iteration mark
                { "\u30fe", new NormalizeResult("\u30fe", "\u30fd\u3099", "\u30fe", "\u30fd\u3099") },
                // not equal to
                { "\u2260", new NormalizeResult("\u2260", "\u003d\u0338", "\u2260", "\u003d\u0338") },
                // angstrom sign
                { "\u212b", new NormalizeResult("\u00c5", "\u0041\u030a", "\u00c5", "\u0041\u030a") },
                ...
                { "\u2033", new NormalizeResult("\u2033", "\u2033", "\u2032\u2032", "\u2032\u2032") },
                // degree celsius
                { "\u2103", new NormalizeResult("\u2103", "\u2103", "\u00b0\u0043", "\u00b0\u0043") },
                // double integral
                { "\u222c", new NormalizeResult("\u222c", "\u222c", "\u222b\u222b", "\u222b\u222b") },
                // roman numeral three
                { "\u2162", new NormalizeResult("\u2162", "\u2162", "\u0049\u0049\u0049", "\u0049\u0049\u0049") },
                // small roman numeral seven
                { "\u2176", new NormalizeResult("\u2176", "\u2176", "\u0076\u0069\u0069", "\u0076\u0069\u0069") },
                // japanese squre miri
                { "\u3349", new NormalizeResult("\u3349", "\u3349", "\u30df\u30ea", "\u30df\u30ea") },
                // japanese squre doru
                { "\u3326", new NormalizeResult("\u3326", "\u3326", "\u30c9\u30eb", "\u30c8\u3099\u30eb") },
                // japanese squre m squared
                { "\u33a1", new NormalizeResult("\u33a1", "\u33a1", "\u006d\u0032", "\u006d\u0032") },
                // japanese sqare era name heisei
                { "\u337b", new NormalizeResult("\u337b", "\u337b", "\u5e73\u6210", "\u5e73\u6210") },
                // numero sign
                { "\u2116", new NormalizeResult("\u2116", "\u2116", "\u004e\u006f", "\u004e\u006f") },
                // squre kk
                { "\u33cd", new NormalizeResult("\u33cd", "\u33cd", "\u004b\u004b", "\u004b\u004b") },
                // telephone sign
                { "\u2121", new NormalizeResult("\u2121", "\u2121", "\u0054\u0045\u004c", "\u0054\u0045\u004c") },
                // japanese circled ideograph high
                { "\u32a4", new NormalizeResult("\u32a4", "\u32a4", "\u4e0a", "\u4e0a") },
                // japanese parenthesized ideograph stock
                { "\u3231", new NormalizeResult("\u3231", "\u3231", "\u0028\u682a\u0029", "\u0028\u682a\u0029") },
                // non-breakable space
                { "\u00a0", new NormalizeResult("\u00a0", "\u00a0", "\u0020", "\u0020") },
                // superscript one
                { "\u00b9", new NormalizeResult("\u00b9", "\u00b9", "\u0031", "\u0031") },
                // superscript two
                { "\u00b2", new NormalizeResult("\u00b2", "\u00b2", "\u0032", "\u0032") },
                // superscript three
                { "\u00b3", new NormalizeResult("\u00b3", "\u00b3", "\u0033", "\u0033") },
                // vulgar faction one quarter
                { "\u00bc", new NormalizeResult("\u00bc", "\u00bc", "\u0031\u2044\u0034", "\u0031\u2044\u0034") },
                // vulgar faction one half
                { "\u00bd", new NormalizeResult("\u00bd", "\u00bd", "\u0031\u2044\u0032", "\u0031\u2044\u0032") },
                // vulgar faction three quarters
                { "\u00be", new NormalizeResult("\u00be", "\u00be", "\u0033\u2044\u0034", "\u0033\u2044\u0034") },
                { "", new NormalizeResult("", "", "", "") } };
    }

    @Test(dataProvider = "nomalizeSamples")
    public void testNormalizeSamples(String src, NormalizeResult expected) {
        assertEquals(normalize(src), expected);
    }
}
