...
public class TestStreamIntermediateOpDemo {
    ...
    public void testFilter() {
        assertThat(Stream.of(3, 2, 1, 5, 1, 2, 3, 4)
            .filter(i -> i > 3)
            .sorted()
            .toArray()).isEqualTo(new Object[] { 4, 5 });
    ...
    public void testMap() {
        assertThat(Stream.of(1, 2, 3, 4, 5)
            .map(i -> i * 2)
            .sorted()
            .toArray()).isEqualTo(new Object[] { 2, 4, 6, 8, 10 });
        assertThat(Stream.of("a", "bb", "ccc", "dddd", "eeeee")
            .map(s -> s.length())
            .sorted()
            .toArray()).isEqualTo(new Object[] { 1, 2, 3, 4, 5 });
    ...
    public void testFlatMap() {
        assertThat(Stream.of(1, 2, 3)
            ...
            .sorted()
            .toArray()).isEqualTo(new Object[] { 10, 11, 12, 20, 21, 22, 30, 31, 32 });
        assertThat(Stream.of("a", "bb", "ccc")
            ...
            .sorted()
            .toArray()).isEqualTo(new Object[] { 'a', 'b', 'b', 'c', 'c', 'c' });
    }
    ...
    public void testLimit() {
        ...
        assertThat(Stream.generate(sup0).limit(5).toArray()).isEqualTo(new Object[] { 1, 2, 3, 4, 5 });
    ...
    public void testSkip() {
        ...
        assertThat(Stream.generate(sup0)
            ...
            .skip(5)
            .toArray()).isEqualTo(new Object[] { 11, 12, 13, 14, 15 });
    ...
    public void testSorted() {
        ...
        assertThat(Stream.of(1, 2, 3, 4, 5)
            ...
            .toArray()).isEqualTo(new Object[] { 5, 4, 3, 2, 1 });
